...
class RunnerWithProjectsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.plugin_runner = PluginsRunner("./data/acl_projects.yml", "./data/sources_projects.yml", "./data/ressources.yml", "tests.plugins", self.query)
    ...
    def test_runner_errors(self):
        ...
        plugin_runner = PluginsRunner("./data/acl_projects.yml", "./data/sources_projects.yml", "./data/ressources.yml", "tests.plugins", self.query2)
        data, errors = plugin_runner()
        self.assertEqual(errors, self.errors_raw)
        self.assertEqual(data, {})
