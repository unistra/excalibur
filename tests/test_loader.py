...
class ConfigurationLoaderTest(TestCase):
    ...
    def setUp(self):
        ...
        self.raw = {'project1': {'sources': {'etab2': {'ip': ['127.0.0.1'],
                                                       'apikey': 'S3CR3T2',
                    'plugins': {'Plugin1': [{'spore': 'S3CR3T2',
                                             'token': 'S3CR3T2'}],
                                'Plugin2': [{'spore': 'S3CR3T2',
                                             'token': 'S3CR3T2'}]}},
                    'etab1': {'ip': ['127.0.0.1'],
                              'apikey': 'S3CR3T',
                    'plugins': {'Plugin1': [
...
class ConfigurationLoaderRawTest(TestCase):
    ...
    def test_load_content_ok(self):
        c = ConfigurationLoader(self.content_ok,
                                "ttretter",
