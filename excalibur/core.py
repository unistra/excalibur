...
class PluginsRunner(object):
    ...
    def check_all(self):
        ...
        decode_arguments.decode(self.__query.ressource, self.__query.method, self.__query.arguments)
    ...
    def run_plugins(self):
        ...
        for plugin_name, parameters_sets in self.plugins.iteritems():
            for parameters_index, parameters in enumerate(parameters_sets):
                ...
                plugin_data = None
                f_name = "%s_%s" % (self.__query.ressource, self.__query.method) # Name of the function to run
